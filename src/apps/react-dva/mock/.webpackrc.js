...
const cdn = {
  test: `https://static2.test.ximalaya.com/yx/${packageJson.name}/last/dist/`,
  uat: `https://s1.uat.xmcdn.com/yx/${packageJson.name}/last/dist/`,
  prod: `https://s1.xmcdn.com/yx/${packageJson.name}/last/dist/`,
};
